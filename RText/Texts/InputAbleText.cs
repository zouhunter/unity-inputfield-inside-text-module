...
namespace RText
{
    public class InputAbleText : RectEntryText, IPointerClickHandler
    {
        ...
        class InputFieldEntry
        {
            ...
            public void Init(int index, InputField InputPrefab, Transform parent, Action<int, string> onEndEdit)
            {
            ...
            public void SetRect(Rect rect)
            {
                ...
                rectTransform.sizeDelta = new Vector2(rect.size.x,rectTransform.sizeDelta.y);
            }
        }
        ...
        private InputFieldEntry GetInputFiendEntry(int index, Action<int, string> onEndEdit)
        {
            ...
            inputFieldEntry.Init(index, inputFieldPrefab, transform, onEndEdit);
